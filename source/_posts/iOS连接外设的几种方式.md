...
![](https://github.com/williamxiewz/williamxie-github-io/raw/master/ioscomwithother.png)
<!-- more -->
可以分为三大类：

第一类是通过网络端口，建立Socket使用`TCP/IP协议族`进行通信，天然支持多通道，想要几个通道就建几个socket就行了。
...
关于如何使用BLE进行硬件连接，可以参考本人在github的一个小开源项目[（https://github.com/luoxubin/BlueTooth4.0）](https://github.com/luoxubin/BlueTooth4.0)。另外本人自己业余时间也做过一个BLE连接外设的App-裤宝（名字有创意吧，裤子里的宝贝，是跟我另外两个小伙伴一起做的创业项目，目前该项目黄了， 不过app还在线上，AppStore里搜索“裤宝”可以下载。
...
http://www.cocoachina.com/ios/20160804/17239.html
