...
categories:  iOS SDK
tags:    [软件测试,UI Testing]
---

>本文译自:[iOS9 Day-by-Day :: Day 2 :: UI Testing](https://www.shinobicontrols.com/blog/ios9-day-by-day-day2-ui-testing)
...
![](https://www.shinobicontrols.com/wp-content/uploads/2015/07/newProject.png)

demo中的项目设置很简单，但是足够我们展示在Xcode 7中UI Testing是如何工作的了。

![](https://www.shinobicontrols.com/wp-content/uploads/2015/07/appLayout.png) 
...
![](https://www.shinobicontrols.com/wp-content/uploads/2015/07/prerecording.png)
...
![](https://www.shinobicontrols.com/wp-content/uploads/2015/07/accessibilityInspector.png)
...
当你解决了问题之后，打开interface builder，在 identity inspector你可以找到Accessibility面板。在这你能打开Accessibility，设置hints,、labels 、identifiers和 traits。这些都是很有用的工具来让Accessibility访问你的界面。
 ...
 ![](https://www.shinobicontrols.com/wp-content/uploads/2015/07/accessibilityPanel.png)
...
![](https://www.shinobicontrols.com/wp-content/uploads/2015/07/testFailure.png)
...
Xcode中的UI Testing的最好的新功能之一，是能在持续集成服务器中执行测试。Xcode bots提供对此的支持，而且[command line](https://krausefx.com/blog/run-xcode-7-ui-tests-from-the-command-line)支持当UI测试失败时会立即发出通知。

#更多
关于Xcode中新的UI Testing的更多内容，我建议你观看WWDC session 406， [UI Testing in Xcode](https://developer.apple.com/videos/wwdc/2015/?id=406)。还推荐阅读  [Testing in Xcode Documentation](https://developer.apple.com/library/prerelease/ios/documentation/DeveloperTools/Conceptual/testing_with_xcode/chapters/Introduction.html#//apple_ref/doc/uid/TP40014132)和 [Accessibility for Developers Documentation](https://developer.apple.com/accessibility/)。